...
<span class="caption">Listing 15-17: Demonstrating we’re not allowed to have two lists using `Box<T>` that try to share ownership of a third list</span>
...
<span class="caption">Listing 15-18: A definition of `List` that uses `Rc<T>`</span>
